...
Modified from https://github.com/craffel/pretty-midi/blob/master/examples/reverse_pianoroll.py
"""
...
def piano_roll_to_pretty_midi(piano_roll, fs=100, program=0,
    ...
    base_note : str or int offset for base of piano roll
    Returns
    -------
    ...
    if isinstance(base_note, str):
        base_note = pretty_midi.note_name_to_number(base_note)

    # pad 1 column of zeros so we can acknowledge inital and ending events
    print(piano_roll.shape)
    piano_roll = np.pad(piano_roll, [(base_note, 0), (1, 1)], 'constant')
    print(piano_roll.shape)
